...
export const translations = {
  ko: {
    ...
    download: {
      ...
      macosWarning: "macOS: 설치 후 터미널에서 xattr -cr /Applications/Daily\\ Reflect.app 실행 필요",
    ...
    guide: {
      ...
      macosNote: "macOS: 설치 후 터미널에서 xattr -cr /Applications/Daily\\ Reflect.app 실행 후 앱을 열어주세요. Windows: SmartScreen 경고 시 \"추가 정보 → 실행\" 클릭.",
  ...
  en: {
    ...
    download: {
      ...
      macosWarning: "macOS: Run xattr -cr /Applications/Daily\\ Reflect.app in Terminal after install",
    ...
    guide: {
      ...
      macosNote: "macOS: Run xattr -cr /Applications/Daily\\ Reflect.app in Terminal after install, then open the app. Windows: Click \"More info → Run anyway\" if SmartScreen warns.",
