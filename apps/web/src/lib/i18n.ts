...
export const translations = {
  ko: {
    ...
    download: {
      ...
      macosWarning: "macOS: .dmg와 함께 fix-macos.command를 다운로드하고, 앱 설치 후 더블클릭하세요",
    ...
    guide: {
      ...
      macosNote: "macOS: .dmg와 함께 fix-macos.command를 다운로드하세요. 앱 설치 후 더블클릭하면 제한이 해제되고 앱이 실행됩니다. Windows: SmartScreen 경고 시 \"추가 정보 → 실행\" 클릭.",
  ...
  en: {
    ...
    download: {
      ...
      macosWarning: "macOS: Download fix-macos.command with .dmg, then double-click it after install",
    ...
    guide: {
      ...
      macosNote: "macOS: Download fix-macos.command alongside the .dmg. After installing the app, double-click the script to remove restrictions and launch. Windows: Click \"More info → Run anyway\" if SmartScreen warns.",
