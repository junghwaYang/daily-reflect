...
export const translations = {
  ko: {
    ...
    download: {
      ...
      postInstallTitle: "설치 후 30초 설정 (중요)",
      postInstallIntro: "앱이 처음 실행되지 않으면 아래 안내를 먼저 진행하세요.",
      macosTerminalLabel: "macOS 터미널 명령어",
      macosTerminalCommand: "xattr -cr /Applications/Daily\\ Reflect.app",
      macosSettingsLabel: "macOS 시스템 설정",
      macosSettingsPath: "개인 정보 보호 및 보안 > \"확인 없이 열기\"",
      windowsActionLabel: "Windows 첫 실행",
      windowsActionPath: "SmartScreen 경고에서 \"추가 정보 → 실행\" 클릭",
      openSource: "오픈소스",
      mit: "MIT 라이선스",
      allDownloads: "전체 다운로드",
      macosWarning: "macOS: 설치 후 터미널에서 xattr -cr /Applications/Daily\\ Reflect.app 실행 또는 시스템 설정 > 보안에서 허용",
      windowsWarning: "Windows: SmartScreen 경고 시 \"추가 정보 → 실행\" 클릭",
    ...
    guide: {
      ...
      back: "홈으로",
      toc: "목차",
      quickStartTitle: "설치 직후 바로 해야 할 것",
      quickStartItems: [
        "macOS: 터미널에서 xattr -cr /Applications/Daily\\ Reflect.app 실행",
        "또는 macOS 시스템 설정 > 개인 정보 보호 및 보안 > \"확인 없이 열기\"",
        "Windows: SmartScreen 경고 시 \"추가 정보 → 실행\" 선택",
      ],
      sections: {
      ...
      macosNote: "macOS: 설치 후 터미널에서 xattr -cr /Applications/Daily\\ Reflect.app 실행, 또는 시스템 설정 > 개인 정보 보호 및 보안에서 \"확인 없이 열기\" 클릭. Windows: SmartScreen 경고 시 \"추가 정보 → 실행\" 클릭.",
  ...
  en: {
    ...
    download: {
      ...
      postInstallTitle: "30-second post-install checklist (Important)",
      postInstallIntro: "If the app does not open on first launch, do this first.",
      macosTerminalLabel: "macOS Terminal command",
      macosTerminalCommand: "xattr -cr /Applications/Daily\\ Reflect.app",
      macosSettingsLabel: "macOS System Settings",
      macosSettingsPath: "Privacy & Security > \"Open Anyway\"",
      windowsActionLabel: "Windows first launch",
      windowsActionPath: "On SmartScreen warning, click \"More info → Run anyway\"",
      openSource: "Open Source",
      mit: "MIT License",
      allDownloads: "All Downloads",
      macosWarning: "macOS: Run xattr -cr /Applications/Daily\\ Reflect.app in Terminal, or allow in System Settings > Security",
      windowsWarning: "Windows: Click \"More info → Run anyway\" if SmartScreen warns",
      osLabels: { macOS: ".dmg", Windows: ".exe", Linux: ".AppImage" },
      stats: [
    ...
    guide: {
      ...
      quickStartTitle: "Do this right after installation",
      quickStartItems: [
        "macOS: Run xattr -cr /Applications/Daily\\ Reflect.app in Terminal",
        "Or go to macOS System Settings > Privacy & Security > \"Open Anyway\"",
        "Windows: On SmartScreen warning, choose \"More info → Run anyway\"",
      ],
      sections: {
      ...
      macosNote: "macOS: Run xattr -cr /Applications/Daily\\ Reflect.app in Terminal after install, or allow in System Settings > Privacy & Security > \"Open Anyway\". Windows: Click \"More info → Run anyway\" if SmartScreen warns.",
